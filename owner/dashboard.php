          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="../dist/assets/img/lulu.jpeg"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Lukiyatul Paroh</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Lukiyatul Paroh - Web Developer
                    <small>Member since Des. 2025</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Lulu Mart</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
...
?>
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://adminlte.io" class="text-decoration-none">Lulu Mart</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
