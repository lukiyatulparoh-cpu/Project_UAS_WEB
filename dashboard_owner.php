...
<html lang="en">
  ...
  <head>
    ...
    <title>Clairmont - Dashboard Owner</title>
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_owner.php?menu=produk">
                    🧁 <span>Produk</span>
                  </a>
                </li>
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_owner.php?menu=customer">
                    👤 <span>Customer</span>
                  </a>
                </li>
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_owner.php?menu=transaksi">
                    🧾 <span>Transaksi</span>
                  </a>
                </li>
