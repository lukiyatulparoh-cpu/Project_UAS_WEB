...
<html lang="en">
  ...
  <head>
    ...
    <title>Clairmont - Dashboard Admin</title>
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_admin.php?menu=produk">
                    🧁 <span>Produk</span>
                  </a>
                </li>
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_admin.php?menu=customer">
                    👤 <span>Customer</span>
                  </a>
                </li>
                ...
                <li>
                  <a class="dropdown-item d-flex align-items-center gap-2"
                    href="dashboard_admin.php?menu=transaksi">
                    🧾 <span>Transaksi</span>
                  </a>
                </li>
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="./dist/assets/img/cust1.jpeg"
                        alt="User Avatar"
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Hai kak! produk apa yang ready banyak?</p>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="./dist/assets/img/cust2.jpeg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Untuk menu yang best sellernya mana ya?</p>
                      <p class="fs-7 text-secondary">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="./dist/assets/img/cust3.jpeg"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Ada dine in nya ga kakk?</p>
                      <p class="fs-7 text-secondary">
...
switch ($menu) {
  ...
  // data transaksi
    ...
    case 'kelola_transaksi':
        include "form/transaksi/kelola_transaksi.php";
        break;
